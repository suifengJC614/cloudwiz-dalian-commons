...
public class SingleRowConfig extends EvaluationConfig implements ContentConfig {

    public static final String ELEMENT_NAME = "single-row";

    public SingleRowConfig(Element config, ExportConfig exportConfig) {
